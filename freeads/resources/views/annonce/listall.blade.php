                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                                <a href="/annonce/info/{{$annonce['id']}}">
                                    <div class="card">
                                        @if(isset($annonce['image1']))
                                        <img class="card-img" src="uploads/annonce/{{$annonce['image1']}}" alt="Vans">
                                        @else
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="buy d-flex justify-content-between align-items-center">
                                                <div class="price text-success"><h5 class="mt-4">${{$annonce['prix']}}</h5></div>
                                                    <a href="/annonce/info/{{$annonce['id']}}" class="btn btn-danger">En savoir plus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
